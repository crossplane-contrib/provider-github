pipeline {
    ...
    environment {
        ...
        CODECOV_TOKEN = credentials('codecov-provider-github')
    }
            ...
            steps {
                script {
                    if (env.CHANGE_ID != null) {
                        def json = sh (script: "curl -s https://api.github.com/repos/crossplane/provider-github/pulls/${env.CHANGE_ID}", returnStdout: true).trim()
